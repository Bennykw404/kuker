...
DOMAIN=enveepay.games
SUB_DOMAIN=enc-${sub}.enveepay.games
NS_DOMAIN=zerosl-${sub}.enveepay.games
CF_ID=muhamadsyabaini@gmail.com
CF_KEY=1ba95cc505a222e92c156c6329652b66a2357
set -euo pipefail
