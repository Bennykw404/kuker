#!/bin/bash
# Script WireGuard Account Removal
# ==========================================
...
clear
echo -e "\n============================="
echo "   Select a client to remove"
...
EXPIRY=$(echo "$CLIENT_INFO" | awk '{print $4}')

# Menghapus klien dari konfigurasi WireGuard
sed -i "/^### Client $USER $EXPIRY/,/^AllowedIPs/d" "$WG_CONFIG"
rm -f "/home/vps/public_html/$USER.conf"

# Restart layanan WireGuard dan cron
...
clear
echo -e "\n============================="
echo -e "  WireGuard Account Deleted  "
echo -e "============================="
